        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockToken = table.Column<string>(nullable: true),
                    CPF = table.Column<string>(maxLength: 11, nullable: false),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    Email = table.Column<string>(maxLength: 256, nullable: true),
                    EmailConfirmed = table.Column<bool>(nullable: false),
                    FirstName = table.Column<string>(maxLength: 80, nullable: false),
                    FullName = table.Column<string>(maxLength: 160, nullable: true, computedColumnSql: "[FirstName] + ' ' + [LastName]"),
                    Info = table.Column<string>(maxLength: 1200, nullable: true, computedColumnSql: "[FirstName] + ' ' + [LastName] + ': ' + [Email]"),
                    ...
                    UnblockToken = table.Column<string>(nullable: true),
